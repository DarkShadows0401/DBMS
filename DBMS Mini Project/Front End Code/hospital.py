...
class Hospital:
    def __init__(self, root):
        ...
        Dataframe.place(x=0, y=130, width=1280, height=360)

        dataframeLeft = LabelFrame(Dataframe, bd=10, relief=RIDGE, padx=10,
                                   font=("Times New Roman", 50, "bold"), text="Patient Information")
        dataframeLeft.place(x=10, y=5, width=970, height=300)

        dataframeRight = LabelFrame(Dataframe, bd=10, relief=RIDGE, padx=10,
                                    font=("Times New Roman", 50, "bold"), text="Prescription")
        dataframeRight.place(x=990, y=5, width=423, height=300)

        # =========================Buttons Frame========================

        ButtonFrame = Frame(self.root, bd=20, relief=RIDGE)
        ButtonFrame.place(x=10, y=470, width=1280, height=50)
        ...
        def PrescriptionData(self):
            if self.Nameoftablets.get() == "" or self.ReferenceNo.get() == "":
                ...
                conn = mysql.connector.connect(
                    host="127.0.0.1", username="root", password="Sayyam@123", database="mydata")
